...
/* harmony export */ });
/* harmony import */ var local_storage_manager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
...
/* harmony import */ var _texteditor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);
/* harmony import */ var _input__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(81);
/* harmony import */ var _languages__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(83);
/* harmony import */ var _player_player__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(77);
/* harmony import */ var _ui__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(84);
/* harmony import */ var _timestamps__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(76);
/* harmony import */ var _backup__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(93);
/* harmony import */ var _export__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(95);
/* harmony import */ var _import__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(107);
/* harmony import */ var _view_controller__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(108);
/* harmony import */ var _silent_audio__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(109);
...
/* harmony import */ var _softcatala__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(110);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(111);
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            (0,_backup__WEBPACK_IMPORTED_MODULE_7__.initBackup)();
            (0,_texteditor__WEBPACK_IMPORTED_MODULE_1__.watchFormatting)();
            (0,_languages__WEBPACK_IMPORTED_MODULE_3__["default"])();
            (0,_timestamps__WEBPACK_IMPORTED_MODULE_6__.activateTimestamps)();
            (0,_export__WEBPACK_IMPORTED_MODULE_8__.exportSetup)();
            (0,_import__WEBPACK_IMPORTED_MODULE_9__["default"])();
            (0,_texteditor__WEBPACK_IMPORTED_MODULE_1__.initAutoscroll)(); // this is necessary due to execCommand restrictions
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initAutoscroll": () => (/* binding */ initAutoscroll),
/* harmony export */   "setEditorContents": () => (/* binding */ setEditorContents),
/* harmony export */   "watchFormatting": () => (/* binding */ initWatchFormatting),
/* harmony export */   "watchWordCount": () => (/* binding */ initWordCount)
/* harmony export */ });
/* harmony import */ var _clean_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6);
/* harmony import */ var _timestamps__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(76);
...
function countTextbox() {
  ...
  var wordcountText = document.webL10n.get('wordcount', {
    n: count
  });
  wordcountText = wordcountText.replace(/(\d+)/, function (n) {
    return "<span class=\"word-count-number\">".concat(n, "</span>");
  });
...
function setEditorContents(dirtyText) {
  ...
  var newText = (0,_clean_html__WEBPACK_IMPORTED_MODULE_0__.cleanHTML)(dirtyText);
  var $textbox = $("#textbox");
  ...
  function replaceText() {
    ...
    (0,_timestamps__WEBPACK_IMPORTED_MODULE_1__.activateTimestamps)();
...
function initAutoscroll() {
  ...
  var textbox = document.querySelector('#textbox'); // update isScrolledToBottom on scroll event (true within 50px of the bottom of container)
...
/* harmony export */ });
var sanitizeHtml = __webpack_require__(7);
...
const htmlparser = __webpack_require__(8);
const escapeStringRegexp = __webpack_require__(38);
const { isPlainObject } = __webpack_require__(39);
const deepmerge = __webpack_require__(40);
const parseSrcset = __webpack_require__(41);
const { parse: postcssParse } = __webpack_require__(42);
...
var ElementType = __importStar(__webpack_require__(17));
...
exports.DomUtils = __importStar(__webpack_require__(20));
var FeedHandler_1 = __webpack_require__(19);
...
var Tokenizer_1 = __importDefault(__webpack_require__(10));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var decode_codepoint_1 = __importDefault(__webpack_require__(11));
var entities_json_1 = __importDefault(__webpack_require__(13));
var legacy_json_1 = __importDefault(__webpack_require__(14));
var xml_json_1 = __importDefault(__webpack_require__(15));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var decode_json_1 = __importDefault(__webpack_require__(12));
...
var domhandler_1 = __importDefault(__webpack_require__(16));
var DomUtils = __importStar(__webpack_require__(20));
var Parser_1 = __webpack_require__(9);
...
var domhandler_1 = __webpack_require__(16);
var dom_serializer_1 = __importDefault(__webpack_require__(22));
var domelementtype_1 = __webpack_require__(17);
/**
 ...
 */
var ElementType = __importStar(__webpack_require__(17));
var entities_1 = __webpack_require__(23);
/**
 ...
 */
var foreignNames_1 = __webpack_require__(31);
...
var decode_1 = __webpack_require__(24);
var encode_1 = __webpack_require__(30);
/**
...
var encode_2 = __webpack_require__(30);
...
var decode_2 = __webpack_require__(24);
...
var legacy_json_1 = __importDefault(__webpack_require__(26));
var xml_json_1 = __importDefault(__webpack_require__(27));
var decode_codepoint_1 = __importDefault(__webpack_require__(28));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var decode_json_1 = __importDefault(__webpack_require__(29));
// Adapted from https://github.com/mathiasbynens/he/blob/master/src/he.js#L94-L119
var fromCodePoint = 
// eslint-disable-next-line @typescript-eslint/no-unnecessary-condition
String.fromCodePoint ||
...
var domhandler_1 = __webpack_require__(16);
var querying_1 = __webpack_require__(34);
var Checks = {
...
var stringify_1 = __webpack_require__(21);
var legacy_1 = __webpack_require__(35);
/**
...
let CssSyntaxError = __webpack_require__(43)
let Declaration = __webpack_require__(46)
let LazyResult = __webpack_require__(51)
let Container = __webpack_require__(60)
let Processor = __webpack_require__(73)
let stringify = __webpack_require__(50)
let fromJSON = __webpack_require__(75)
let Document = __webpack_require__(62)
let Warning = __webpack_require__(65)
let Comment = __webpack_require__(61)
let AtRule = __webpack_require__(69)
let Result = __webpack_require__(64)
let Input = __webpack_require__(56)
let parse = __webpack_require__(66)
let list = __webpack_require__(72)
let Rule = __webpack_require__(71)
let Root = __webpack_require__(70)
let Node = __webpack_require__(47)
...
let pico = __webpack_require__(44)

let terminalHighlight = __webpack_require__(45)
...
let { isClean, my } = __webpack_require__(48)
let CssSyntaxError = __webpack_require__(43)
let Stringifier = __webpack_require__(49)
let stringify = __webpack_require__(50)
...
let { isClean, my } = __webpack_require__(48)
let MapGenerator = __webpack_require__(52)
let stringify = __webpack_require__(50)
let Container = __webpack_require__(60)
let Document = __webpack_require__(62)
let warnOnce = __webpack_require__(63)
let Result = __webpack_require__(64)
let parse = __webpack_require__(66)
let Root = __webpack_require__(70)
...
let { SourceMapConsumer, SourceMapGenerator } = __webpack_require__(53)
let { dirname, resolve, relative, sep } = __webpack_require__(54)
let { pathToFileURL } = __webpack_require__(55)
...
let { SourceMapConsumer, SourceMapGenerator } = __webpack_require__(53)
let { fileURLToPath, pathToFileURL } = __webpack_require__(55)
let { resolve, isAbsolute } = __webpack_require__(54)
let { nanoid } = __webpack_require__(57)

let terminalHighlight = __webpack_require__(45)
let CssSyntaxError = __webpack_require__(43)
let PreviousMap = __webpack_require__(58)
...
let { SourceMapConsumer, SourceMapGenerator } = __webpack_require__(53)
let { existsSync, readFileSync } = __webpack_require__(59)
let { dirname, join } = __webpack_require__(54)
...
let Container = __webpack_require__(60)
let Parser = __webpack_require__(67)
let Input = __webpack_require__(56)
...
let Declaration = __webpack_require__(46)
let tokenizer = __webpack_require__(68)
let Comment = __webpack_require__(61)
let AtRule = __webpack_require__(69)
let Root = __webpack_require__(70)
let Rule = __webpack_require__(71)
...
let NoWorkResult = __webpack_require__(74)
let LazyResult = __webpack_require__(51)
let Document = __webpack_require__(62)
let Root = __webpack_require__(70)
...
let warnOnce = __webpack_require__(63)
let parse = __webpack_require__(66)
const Result = __webpack_require__(64)
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "activateTimestamps": () => (/* binding */ activateTimestamps),
/* harmony export */   "convertTimestampToSeconds": () => (/* binding */ convertTimestampToSeconds),
/* harmony export */   "createTimestampEl": () => (/* binding */ createTimestampEl),
/* harmony export */   "formatMilliseconds": () => (/* binding */ formatMilliseconds),
/* harmony export */   "insertTimestamp": () => (/* binding */ insertTimestamp)
/* harmony export */ });
/* harmony import */ var _player_player__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(77);


function getTime() {
  // get timestamp
  var player = (0,_player_player__WEBPACK_IMPORTED_MODULE_0__.getPlayer)();
  var time = 0;
...
function insertHTML(newElement) {
  ...
  if (window.getSelection && (sel = window.getSelection()).rangeCount) {
    ...
    range.collapse(true);
    range.insertNode(newElement); // Move the caret immediately after the inserted span
...
function activateTimestamps() {
  Array.from(document.querySelectorAll('.timestamp')).forEach(function (el) {
...
window.ts = {
  setFrom: function setFrom(clickts, element) {
    var player = (0,_player_player__WEBPACK_IMPORTED_MODULE_0__.getPlayer)();
    var time = this.dataset.timestamp;
...
/* harmony export */   "isVideoFormat": () => (/* binding */ isVideoFormat),
/* harmony export */   "playerDrivers": () => (/* binding */ playerDrivers)
/* harmony export */ });
/* harmony import */ var _html5_audio__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(78);
/* harmony import */ var _html5_video__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(79);
/* harmony import */ var _youtube__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(80);
...
var Player = /*#__PURE__*/function () {
  function Player(opts, callback) {
    ...
    this.driver = new opts.driver(source, function () {
      if (_this.onPlayPauseCallback) {
        _this.onPlayPauseCallback(_this.getStatus());
      }
    });
    this.skipTime = 1.5;
    ...
    var setPlayerHeight = function setPlayerHeight() {
      var videoEl = document.querySelector('.video-player');

      if (videoEl) {
        videoEl.style.height = "".concat(videoEl.offsetWidth * (3 / 4), "px");
      }
    };
  ...
  _createClass(Player, [{
    ...
    value: function skip(direction) {
      ...
      this.setTime(expectedTime); // compensate for weird video setTime bug

      if (expectedTime > 1 && this.getTime() === 0) {
        console.error('Skipped too far back');
        setTimeout(function () {
          return _this2.setTime(expectedTime);
        }, 50);
      }
    }
  }, {
    ...
    key: "speed",
    value: function speed(direction) {
    ...
    key: "onSpeedChange",
    value: function onSpeedChange(callback) {
      this.onSpeedChangeCallback = callback;
    }
  }, {
    key: "onPlayPause",
    value: function onPlayPause(callback) {
...
;
var playerDrivers = {
  HTML5_AUDIO: _html5_audio__WEBPACK_IMPORTED_MODULE_0__["default"],
  HTML5_VIDEO: _html5_video__WEBPACK_IMPORTED_MODULE_1__["default"],
  YOUTUBE: _youtube__WEBPACK_IMPORTED_MODULE_2__["default"]
};
var player = null;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ HTML5_AUDIO)
/* harmony export */ });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var HTML5_AUDIO = /*#__PURE__*/function () {
  function HTML5_AUDIO(source) {
    _classCallCheck(this, HTML5_AUDIO);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ HTML5_VIDEO)
/* harmony export */ });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var HTML5_VIDEO = /*#__PURE__*/function () {
  function HTML5_VIDEO(source) {
    _classCallCheck(this, HTML5_VIDEO);
...
var YOUTUBE = /*#__PURE__*/function () {
  function YOUTUBE(source, playPauseCallback) {
    var _this = this;
    ...
    loadScriptTag(function () {
      ...
      _this._ytEl = new YT.Player('oTplayerEl', {
        width: '100%',
        videoId: videoId,
        playerVars: {
          // controls: 0,
        ...
        events: {
          'onReady': onYTPlayerReady.bind(_this),
          'onStateChange': onStateChange.bind(_this)
        }
      });
      ...
      function onYTPlayerReady() {
        ...
        $('input.speed-slider').val(0.5).change().val(1).change(); // Some YouTube embeds only support normal speed
  ...
  _createClass(YOUTUBE, [{
    ...
    key: "getName",
    value: function getName() {// oTplayer.prototype._setYoutubeTitle = function(id){
...
/* harmony import */ var local_storage_manager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var local_storage_manager__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(local_storage_manager__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var otinput__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(82);
/* harmony import */ var otinput__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(otinput__WEBPACK_IMPORTED_MODULE_1__);
...
function inputSetup(opts) {
  ...
  if (is_iOS()) {
    document.querySelector('.file-input-outer input[type="file"]').removeAttribute('accept');
  }
...
function getQueryParams() {
  return location.search.slice(1).split('&').reduce(function (acc, curr) {
...
function setLang(lang) {
  if (lang) {
    local_storage_manager__WEBPACK_IMPORTED_MODULE_0___default().setItem('oTranscribe-language', lang);
...
function applyLang(callback) {
  var lang = local_storage_manager__WEBPACK_IMPORTED_MODULE_0___default().getItem('oTranscribe-language');
...
function addMarkup() {
  var buttons = Object.keys(languages).sort().map(function (code) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "addKeyboardShortcut": () => (/* binding */ addKeyboardShortcut),
/* harmony export */   "bindPlayerToUI": () => (/* binding */ bindPlayerToUI),
/* harmony export */   "correctModKey": () => (/* binding */ correctModKey),
/* harmony export */   "getFormattedShortcutFor": () => (/* binding */ getFormattedShortcutFor),
/* harmony export */   "keyboardShortcutSetup": () => (/* binding */ keyboardShortcutSetup)
/* harmony export */ });
/* harmony import */ var _player_player__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(77);
/* harmony import */ var _timestamps__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(76);
/* harmony import */ var _time_selection_modal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(87);
/* harmony import */ var _settings_settings_jsx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(88);
/******************************************
             User Interaction
******************************************/
var $ = __webpack_require__(3);
...
var Progressor = __webpack_require__(86);
...
function bindPlayerToUI() {
  ...
  var shortcuts = (0,_settings_settings_jsx__WEBPACK_IMPORTED_MODULE_3__.getSettings)().keyboardShortcuts.shortcuts;
  var player = (0,_player_player__WEBPACK_IMPORTED_MODULE_0__.getPlayer)();
  ...
  addKeyboardShortcut(shortcuts.timeSelection, _time_selection_modal__WEBPACK_IMPORTED_MODULE_2__["default"].toggle);
  $('.player-time').off().click(_time_selection_modal__WEBPACK_IMPORTED_MODULE_2__["default"].toggle);
  var changingSpeed = false;
  $('.speed-slider').attr('min', player.minSpeed).attr('max', player.maxSpeed).attr('step', player.speedIncrement).off().on('change', function () {
    player.setSpeed(this.valueAsNumber);
  });
  player.onSpeedChange(function (speed) {
    $('.speed-slider').val(speed);
  });
  addKeyboardShortcut(shortcuts.speedDown, function () {
    player.speed('down');
  });
  addKeyboardShortcut(shortcuts.speedUp, function () {
    player.speed('up');
  ...
  var playerHook = document.querySelector('#player-hook');
  ...
  player.onPlayPause(function (status) {
    if (status === 'playing') {
...
function keyboardShortcutSetup() {
  var shortcuts = (0,_settings_settings_jsx__WEBPACK_IMPORTED_MODULE_3__.getSettings)().keyboardShortcuts.shortcuts;
  addKeyboardShortcut(shortcuts.bold, function () {
    return document.execCommand('bold', false, null);
  });
  addKeyboardShortcut(shortcuts.italic, function () {
    return document.execCommand('italic', false, null);
  });
  addKeyboardShortcut(shortcuts.underline, function () {
    return document.execCommand('underline', false, null);
  });
  addKeyboardShortcut(shortcuts.addTimestamp, function () {
    return (0,_timestamps__WEBPACK_IMPORTED_MODULE_1__.insertTimestamp)();
  });
  addKeyboardShortcut(shortcuts.returnToStart, function () {
    var player = (0,_player_player__WEBPACK_IMPORTED_MODULE_0__.getPlayer)();
    player.skipTo(0);
  });
  setKeyboardShortcutsinUI();
}
var correctModKey = function correctModKey(binding) {
  var isMac = window.navigator.platform.indexOf('Mac') > -1;
  var modKey = isMac ? '⌘' : 'Ctrl';
  return binding.replace(/mod/g, modKey);
};
var getFormattedShortcutFor = function getFormattedShortcutFor(shortcut, shortcuts) {
  if (!shortcuts) {
    shortcuts = (0,_settings_settings_jsx__WEBPACK_IMPORTED_MODULE_3__.getSettings)().keyboardShortcuts.shortcuts;
  }

  if (shortcut in shortcuts && shortcuts[shortcut].length > 0) {
    var text = shortcuts[shortcut][0];
...
var timeSelectionModalActive = false;
var $timeSelection = $('.controls .time-selection');
...
var show = function show() {
  ...
  if (timeSelectionModalActive === true) {
    ...
    $timeSelection.find('input').off().val((0,_timestamps__WEBPACK_IMPORTED_MODULE_1__.formatMilliseconds)(player.getTime())).keyup(onTimeSelectionModalSubmit).focus().select();
  } else {
    $('.controls .time-selection').removeClass('active');
  }
  ...
  function onTimeSelectionModalSubmit(ev) {
    if (ev.keyCode === 13) {
      ...
      if (time.indexOf(':') > -1) {
        player.setTime((0,_timestamps__WEBPACK_IMPORTED_MODULE_1__.convertTimestampToSeconds)(time));
      } else {
...
/* harmony export */ });
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(89);
/* harmony import */ var _KeyboardShortcuts_jsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(90);
/* harmony import */ var _ui__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(84);
/* harmony import */ var _defaults_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(92);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var localStorageManager = __webpack_require__(4);


function getSettings() {
  var savedSettings = localStorageManager.getItem('oTranscribe-settings');
  var settings = Object.assign({}, _defaults_json__WEBPACK_IMPORTED_MODULE_3__);

  if (savedSettings) {
    settings = Object.assign({}, _defaults_json__WEBPACK_IMPORTED_MODULE_3__, savedSettings);
  }
...
refreshApp.keyboardShortcuts = function (state, prevState) {
  (0,_ui__WEBPACK_IMPORTED_MODULE_2__.bindPlayerToUI)();
  (0,_ui__WEBPACK_IMPORTED_MODULE_2__.keyboardShortcutSetup)(); // TODO: check if any keyboard shortcuts are no longer present in current state

  var shortcuts = state.keyboardShortcuts.shortcuts;
  var prevShortcuts = prevState.keyboardShortcuts.shortcuts;
};
  ...
  _createClass(Settings, [{
    ...
    value: function render() {
      var update = function update(key, value) {
        this.setState(_defineProperty({}, key, Object.assign({}, value)));
      };

      var reset = function reset(key) {
        this.setState(_defineProperty({}, key, _defaults_json__WEBPACK_IMPORTED_MODULE_3__[key]));
      };

      return (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("h2", {
        "class": "panel-title"
      }, document.webL10n.get("settings")), (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(_KeyboardShortcuts_jsx__WEBPACK_IMPORTED_MODULE_1__["default"], {
...
function showSettings(el) {
  (0,preact__WEBPACK_IMPORTED_MODULE_0__.render)((0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(Settings, null), el);
}
...
/* harmony export */ });
/* harmony import */ var preact__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(89);
/* harmony import */ var keycode__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(91);
  ...
  _createClass(Shortcut, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          keyCombos = _this$props.keyCombos,
          onChange = _this$props.onChange;

      var listenForShortcut = function listenForShortcut(keyFn) {
        var _this = this;

        this.setState({
          listening: true
        });
        listen(function (newKeyCombo) {
      ...
      var cancelListen = function cancelListen() {
        this.setState({
          listening: false
        });
      };

      var removeCombo = function removeCombo(keyFn, index) {
        keyCombos.splice(index, 1);
        onChange(keyFn, keyCombos);
      };

      var combos = keyCombos.map(function (combo, i) {
        return (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("span", {
          className: "key-combo"
        }, (0,_ui__WEBPACK_IMPORTED_MODULE_2__.correctModKey)(combo), (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("span", {
          className: "remove-combo",
          onClick: removeCombo.bind(_this2, keyFn, i)
      ...
      if (this.state.listening) {
        combos.push((0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("span", {
          className: "listening-combo"
        }, document.webL10n.get('listening'), (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("span", {
          onClick: cancelListen.bind(this)
      ...
      return (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("li", null, (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
        "class": "shortcut-name"
      }, document.webL10n.get(keyFn)), (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
        "class": "shortcut-combos"
      }, combos));
    }
  }]);
...
function KeyboardShortcutPanel(props) {
  var onChange = function onChange(keyFn, keyCombos) {
    props.settings.shortcuts[keyFn] = keyCombos;
    props.onChange(props.settings);
  };

  var shortcutList = Object.keys(props.settings.shortcuts).map(function (k) {
    return (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(Shortcut, {
      keyFn: k,
      keyCombos: props.settings.shortcuts[k],
      onChange: onChange
    });
  });
  return (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("div", null, (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("h3", null, document.webL10n.get('keyboard-shortcuts')), (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("ul", {
    className: "keyboard-shortcuts"
  }, shortcutList), (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
...
var listen = function listen(cb) {
  var eventHandler = function eventHandler(event) {
    var key = keycode__WEBPACK_IMPORTED_MODULE_1___default()(event);
...
"use strict";
module.exports = JSON.parse('{"keyboardShortcuts":{"shortcuts":{"playPause":["escape"],"backwards":["f1","mod+1"],"forwards":["f2","mod+2"],"returnToStart":["mod+0"],"timeSelection":["mod+k"],"speedDown":["f3","mod+3"],"speedUp":["f4","mod+4"],"addTimestamp":["mod+j"],"bold":["mod+b"],"italic":["mod+i"],"underline":["mod+u"]}}}');
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "initBackup": () => (/* binding */ init)
/* harmony export */ });
/* harmony import */ var _message_panel__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(94);
/* harmony import */ var _texteditor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);
/* harmony import */ var _ui__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(84);
var $ = __webpack_require__(3);
...
function init() {
  localStorageManager.onFull = function () {
    ...
    (0,_message_panel__WEBPACK_IMPORTED_MODULE_0__["default"])(backupClearMessage);
  };
  ...
  (0,_ui__WEBPACK_IMPORTED_MODULE_2__.addKeyboardShortcut)('mod+s', function () {
    return saveBackup();
  });
...
function autosaveInit() {
  var field = document.querySelector("#textbox"); // load existing autosave (if present)

  try {
    var autosaveContents = localStorageManager.getItem("autosave");

    if (autosaveContents) {
      (0,_texteditor__WEBPACK_IMPORTED_MODULE_1__.setEditorContents)(localStorageManager.getItem("autosave"));
    }
  } catch (e) {// don't load autosave, as it's corrupted
  } // autosave every second - but wait five seconds before kicking in


  setTimeout(function () {
    // prevent l10n from replacing user text
    var markupWithL10nData = Array.from(field.querySelectorAll('p[data-l10n-id]'));
    markupWithL10nData.forEach(function (el) {
...
function formatDate(timestamp) {
  ...
  var yesterday = now.getDate() - 1 + '/' + (now.getMonth() + 1);
...
function generateBlock(ref) {
  ...
  restoreButton.innerHTML = "".concat(date, " - <span data-restore=").concat(timestamp, ">").concat(restoreText, "</span>");
...
function listFiles() {
  ...
  try {
    ...
    (0,_message_panel__WEBPACK_IMPORTED_MODULE_0__["default"])('Error listing files from localStorage. Manually clearing localStorage data may fix this. <a href="./help#why_is_otranscribe_is_no_longer_saving_backups">Instructions here</a>.');
    throw e;
  }
...
function saveBackup() {
  ...
  localStorageManager.setItem('oTranscribe-backup-' + timestamp, text); // and bleep icon

  $('.sbutton.backup').addClass('flash');
  setTimeout(function () {
    $('.sbutton.backup').removeClass('flash');
  }, 1000); // and add to tray
...
function restoreBackup(timestamp) {
  ...
  try {
    ...
    if (item) {
      var newText = item;
      (0,_texteditor__WEBPACK_IMPORTED_MODULE_1__.setEditorContents)(newText, {
        transition: true
      });
    } else {
      (0,_message_panel__WEBPACK_IMPORTED_MODULE_0__["default"])(restoreErrorMessage);
    }
  } catch (e) {
    (0,_message_panel__WEBPACK_IMPORTED_MODULE_0__["default"])(restoreErrorMessage);
  }
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(msg) {
  ...
  var stickyWatch = setInterval(function () {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "exportSetup": () => (/* binding */ exportSetup)
/* harmony export */ });
/* harmony import */ var _html_export_panel_ms__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(105);
/* harmony import */ var _html_export_panel_ms__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_html_export_panel_ms__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _export_formats_google_drive__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(106);
/* harmony import */ var _player_player__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(77);
/* harmony import */ var _clean_html__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6);
var $ = __webpack_require__(3);

var Mustache = __webpack_require__(96);

var toMarkdown = __webpack_require__(97);
...
exportFormats.download.push({
  ...
  extension: 'md',
  fn: function fn(txt) {
    var fullyClean = sanitizeHtml(txt, {
...
function generateButtons(filename) {
  var downloadData = exportFormats.download.map(function (format) {
    var clean = (0,_clean_html__WEBPACK_IMPORTED_MODULE_3__.cleanHTML)(getTexteditorContents());
    var file = format.fn(clean);
  ...
  if (checkDownloadAttrSupport() === false) {
    downloadData.forEach(function (format) {
      format.href = convertToBase64(format.file);
    });
  }

  return Mustache.render((_html_export_panel_ms__WEBPACK_IMPORTED_MODULE_0___default()), {
...
function exportSetup() {
  $('.textbox-container').click(function (e) {
    if ($(e.target).is('#icon-exp') || $(e.target).is('.export-panel') || $(e.target).is('.sbutton.export')) {
      e.preventDefault();
      return;
    }
  ...
  $('.sbutton.export').click(function () {
    ...
    $('.export-panel').html(generateButtons(filename));
    exportFormats.send.forEach(function (format) {
      if (format.ready) {
        format.fn(data);
      } else {
...
var toMarkdown
var converters
var mdConverters = __webpack_require__(98)
var gfmConverters = __webpack_require__(99)
var HtmlParser = __webpack_require__(100)
var collapse = __webpack_require__(102)
...
function createHtmlParser () {
  ...
  if (typeof document === 'undefined') {
    var jsdom = __webpack_require__(101)
...
var voidElements = __webpack_require__(103);
Object.keys(voidElements).forEach(function (name) {
  voidElements[name.toUpperCase()] = 1;
});

var blockElements = {};
(__webpack_require__(104).forEach)(function (name) {
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(callbackFn) {
  var currentText = '';
  var currentFilename = '';
  var gd = {
  ...
  gd.button = function () {
    ...
    var text = '<a class="export-block-gd unauth" id="x-gd" target="_blank" href="javascript:void(0);">Google Drive<div class="sign-in" id="x-gd-sign">' + signIn + '</div></a>';
    return text;
  };
  ...
  var createReader = function createReader() {
...
function loadFile(fileRaw) {
  try {
    ...
    (0,_texteditor__WEBPACK_IMPORTED_MODULE_1__.setEditorContents)(file.text);
    remindOfMediaFile(file.media, file['media-source'], file['media-time']);
  } catch (e) {
    console.warn(e);
    (0,_message_panel__WEBPACK_IMPORTED_MODULE_0__["default"])('This is not a valid oTranscribe format (.otr) file.');
  }
}
...
function remindOfMediaFile(filename, filesource, filetime) {
  if (filename && filename !== '') {
    ...
    var restoreText = 'Restore'; // if ((filesource) && (oTplayer.parseYoutubeURL(filesource))) {
    ...
    (0,_message_panel__WEBPACK_IMPORTED_MODULE_0__["default"])(lastfileText + ' ' + filename); // }
  }
}
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _settings_settings_jsx__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(88);
...
var views = {
  ...
  settings: function settings() {
    ...
    (0,_settings_settings_jsx__WEBPACK_IMPORTED_MODULE_0__.showSettings)($('.settings-panel'));
  }
};
...
/* harmony export */ });
/* harmony import */ var _timestamps__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(76);
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var SC_BASE_URL = "https://api.softcatala.org/transcribe-service/v1/get_file/";

function parseSubtitleFormat(rawSrt) {
  var parsedSrt = document.createElement('p');
  var entries = rawSrt.split("\n\n");
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      var startTime = data[1].substring(0, 8);
      var startTimeSeconds = (0,_timestamps__WEBPACK_IMPORTED_MODULE_0__.convertTimestampToSeconds)(startTime);
      var timestampEl = (0,_timestamps__WEBPACK_IMPORTED_MODULE_0__.createTimestampEl)({
        formatted: startTime,
...
function getTranscriptionText(_x) {
  return _getTranscriptionText.apply(this, arguments);
}

function _getTranscriptionText() {
  _getTranscriptionText = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(uuid) {
    var response, text;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("".concat(SC_BASE_URL, "?uuid=").concat(uuid, "&ext=srt"), {
              method: 'GET'
            });
          ...
          case 2:
            ...
            return _context.abrupt("return", "Error carregant l'arxiu");
          ...
          case 7:
            text = _context.sent;
            return _context.abrupt("return", parseSubtitleFormat(text));
...
function getTranscriptionFileURL(uuid) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetch(getTranscriptionFileURL(uuid), {
              method: 'HEAD'
            });
...
function getTranscriptionFile(_x3) {
  return _getTranscriptionFile.apply(this, arguments);
}

function _getTranscriptionFile() {
  _getTranscriptionFile = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(uuid) {
    var response, fileBlob, contentDisposition, fileType, loadedFile;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 5:
            ...
            contentDisposition = response.headers['content-disposition'];
            fileType = getFileType(contentDisposition);
            loadedFile = new File([fileBlob], "".concat(uuid), {
              type: fileType
            });
            return _context3.abrupt("return", loadedFile);
...
function closeTips() {
  ...
  local_storage_manager__WEBPACK_IMPORTED_MODULE_0___default().setItem('oTranscribe-visible-tips', 1);
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js_app_init__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
__webpack_require__(1);


window.addEventListener('DOMContentLoaded', function () {
  (0,_js_app_init__WEBPACK_IMPORTED_MODULE_0__["default"])();
});
})();
