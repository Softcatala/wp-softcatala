...
function sc_catalanitzador_page_link( $permalink, $postId ) {
	...
	if ( !empty( $catalanitzador ) && is_numeric( $catalanitzador )
		&& $post->post_type == 'programa' && $post->ID == (int)$catalanitzador ) {
			return home_url( '/catalanitzador/' );
	}
...
function sc_custom__rewrite_rules($aRules) {
    ...
    //Programes
    $aNewRules = array(
		'^programes/p/([^/]+)/so/([^/]+)/cat/([^/]+)/pagina/([0-9]+)/?$' => 'index.php?post_type=programa&cerca=$matches[1]&sistema_operatiu=$matches[2]&categoria_programa=$matches[3]&paged=$matches[4]',
        '^programes/p/([^/]+)/so/([^/]+)/cat/([^/]+)/?$' => 'index.php?post_type=programa&cerca=$matches[1]&sistema_operatiu=$matches[2]&categoria_programa=$matches[3]',
		'^programes/p/([^/]+)/so/([^/]+)/pagina/([0-9]+)/?$' => 'index.php?post_type=programa&cerca=$matches[1]&sistema_operatiu=$matches[2]&paged=$matches[3]',
        '^programes/p/([^/]+)/so/([^/]+)/?$' => 'index.php?post_type=programa&cerca=$matches[1]&sistema_operatiu=$matches[2]',
		'^programes/p/([^/]+)/cat/([^/]+)/pagina/([0-9]+)/?$' => 'index.php?post_type=programa&cerca=$matches[1]&categoria_programa=$matches[2]&paged=$matches[3]',
        '^programes/p/([^/]+)/cat/([^/]+)/?$' => 'index.php?post_type=programa&cerca=$matches[1]&categoria_programa=$matches[2]',
		'^programes/p/([^/]+)/pagina/([0-9]+)/?$' => 'index.php?post_type=programa&cerca=$matches[1]&paged=$matches[2]',
        '^programes/p/([^/]+)/?$' => 'index.php?post_type=programa&cerca=$matches[1]',
		'^programes/so/([^/]+)/cat/([^/]+)/pagina/([0-9]+)/?$' => 'index.php?post_type=programa&sistema_operatiu=$matches[1]&categoria_programa=$matches[2]&paged=$matches[3]',
        '^programes/so/([^/]+)/cat/([^/]+)/?$' => 'index.php?post_type=programa&sistema_operatiu=$matches[1]&categoria_programa=$matches[2]',
		'^programes/so/([^/]+)/pagina/([0-9]+)/?$' => 'index.php?post_type=programa&sistema_operatiu=$matches[1]&paged=$matches[2]',
        '^programes/so/([^/]+)/?$' => 'index.php?post_type=programa&sistema_operatiu=$matches[1]',
		'^programes/cat/([^/]+)/pagina/([0-9]+)/?$' => 'index.php?post_type=programa&categoria_programa=$matches[1]&paged=$matches[2]',
    ...
    $aNewRules = array(
        ...
        '^diccionari-angles-catala/(eng|cat)/paraula/([^/]+)/?$' => 'index.php?post_type=page&pagename=diccionari-angles-catala&llengua=$matches[1]&paraula=$matches[2]',
