...
wp_enqueue_script( 'sc-js-steps', get_template_directory_uri() . '/static/js/steps.js', array( 'jquery' ), WP_SOFTCATALA_VERSION, true );
...
if ( ! empty ( $project_slug ) ) {
    ...
    if ( $projecte && \Softcatala\Posts\Projecte::is_internal_post( $projecte->ID ) && ! is_user_logged_in() ) {
