...
wp_enqueue_script( 'sc-js-dict-eng-cat', get_template_directory_uri() . '/static/js/diccionari-eng-cat/diccionari-cat-eng.js', array(), WP_SOFTCATALA_VERSION, true );
...
if( ! empty ( $paraula ) ) {
    try {
	    ...
	    $context_holder['dicc_engcat_result'] = $r->html;
