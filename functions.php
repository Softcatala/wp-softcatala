...
class StarterSite extends TimberSite {
    ...
    function add_to_twig( $twig ) {
        ...
        $twig->addFilter('get_sized_from_media_url', new Twig_SimpleFilter( 'get_sized_from_media_url', 'get_sized_from_media_url' ));
        return $twig;
    }
...
/**
 * This function retrieves the final url of the resized image from a given image media url
 *
 * @param string $url
 * @return string $caption
 */
function get_sized_from_media_url( $attachment_url = '', $size = '127', $position = '' ) {
    ...
    //Not in the original function from the author
    $attachment_sized = wp_get_attachment_image_src( $attachment_id, array('50', '50', 'top') );

    var_dump('ababb');
    var_dump($attachment_id);
    var_dump('aa');
    var_dump($attachment_sized[0]);

    return $attachment_sized[0];
}
